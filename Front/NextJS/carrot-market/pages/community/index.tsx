...
const Community: NextPage = () => {
  return (
    <div className="py-16 px-4 space-y-8">
      {[1, 2, 3, 4, 5, 6].map((_, i) => (
        ...
        >
          ...
          <div className="flex space-x-5 mt-3 text-gray-700 py-2.5 border-t border-b-[2px] w-full">
            <span className="flex spac-x-2 items-center text-sm">
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
      ...
      <button className="fixed cursor-pointer hover:bg-orange-500 transition-colors bottom-24 right-5 shadow-xl bg-orange-400 rounded-full p-5 text-white">
        <svg
          className="w-6 h-6"
          fill="none"
          stroke="currentColor"
