    ...
    <div>
      <div
        className={cls(
          ...
          "bg-white px-10 max-w-lg w-full text-lg font-medium py-3 fixed text-gray-799 border-b top-0 flex  items-center",
        )}
      >
        {canGoBack ? (
      ...
      <div className={cls("py-12", hasTabBar ? "pb-24" : "")}>{children}</div>
